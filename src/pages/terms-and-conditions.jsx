...
const Termsconditions = () => {
  ...
  <div className="forChart termspage">
    <div className="rw">
      ...
      <p>
        By accessing or using A1 Satta you agree to these Terms & Conditions
    ...
    <div className="rw">
      ...
      <p>
        Content on A1 Satta (text, images, logos, charts and code) is owned or
    ...
    <div className="rw">
      ...
      <p>
        A1 Satta provides informational content about results and charts only.
    ...
    <div className="rw">
      ...
      <p>
        📧 <strong>support@A1satta.com</strong>
        <br /> 🌐
        <a href="https://www.A1satta.com/">
          <strong>https://www.A1satta.com</strong>
        </a>
      </p>
    </div>
    <div className="rw">
