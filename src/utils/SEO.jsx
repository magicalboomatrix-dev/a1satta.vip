...
export default function SEO() {
  ...
  // Allow overriding the site for local/dev via env (e.g. VITE_SEO_SITE=a1satta.vip)
  const site = (import.meta.env.VITE_SEO_SITE || normalizedHost || "a1satta.vip").toLowerCase();
